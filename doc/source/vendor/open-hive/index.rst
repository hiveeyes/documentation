...
Clemens is working on the `Open Hive`_ open source / open hardware beehive monitoring project.
He engineered the `Open Hive Bee Scale`_ and `Open Hive Shields`_.
