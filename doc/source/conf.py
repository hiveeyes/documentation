# -*- coding: utf-8 -*-
#
# swarm.hiveeyes.org documentation build configuration file, created by
...
copyright = u'2014-2017, The Hiveeyes Developers'
...
htmlhelp_basename = 'hiveeyessystemdoc'
...
latex_documents = [
  (master_doc, 'hiveeyessystem.tex', u'Hiveeyes system documentation',
...
man_pages = [
    (master_doc, 'hiveeyessystem', u'Hiveeyes system documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'hiveeyessystem', u'Hiveeyes system documentation',
   author, 'hiveeyessystem', 'Hiveeyes hardware and software overview.',
   'Miscellaneous'),
]
